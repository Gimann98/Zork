...
namespace Zork
{
...

    {
        ...
        private static void IntitializeRoomDescription()
        { 
            ...
            roomMap["South of House"].Description = "You are facing the south side of a white house. There is no door here, amd all the windows are barred.";
